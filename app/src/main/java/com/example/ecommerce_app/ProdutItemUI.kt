...
@Composable
fun ProductItemUI(productDataItem: ProductDataItem) {
    ...
    Card(elevation = 4.dp, modifier = Modifier.padding(all = 10.dp)) {
        ...
        Column(modifier = Modifier.padding(all = 10.dp)) {
            Box(modifier = Modifier.size(170.dp,200.dp)){
                Image(
                    painter = painterResource(productDataItem.imageId),
            ...
            Text(
                text = productDataItem.productTitle,
            ...
            Spacer(modifier = Modifier.height(8.dp))
            Text(
                text = "EGP ${productDataItem.ProductPrice}",
                fontSize = 16.sp,
